...
import { listSaleItem, createAuction, lazyMintNFT } from "../../contract/minter";
...
const CreateCollectible = (props) => {
  ...
  const createCollectible = async () => {
    ...
    try {
      if (validate()) {
        ...
        // We should generate signature correctly
  ...
  const fetchUserData = async () =>{
    await Axios.get(`${process.env.REACT_APP_API}/account?address=${String(account)}`)
    .then(res => {
            ...
            <div className="collectible-editor">
              ...
              <div className="collectible-form-control">
                ...
                <div className="form-input-wrapper">
                  <input
                    type="text"
                    className="form-input"
                    placeholder="Write the collection name or leave it blank"
                    value={collection}
              ...
              {mintOption === "auction" && (
                <>
                  ...
                  <div className="collectible-form-control">
                    <span className="form-label">Initial Price (ETH)</span>
                    <div className="form-input-wrapper">
                      <input
                        className="form-input"
                        value={initialPrice}
              ...
              {mintOption === "fixed" && (
                <div className="collectible-form-control">
                  <span className="form-label">Sale Price (ETH)</span>
                  <div className="form-input-wrapper">
                    <input
                      className="form-input"
                      value={price}
