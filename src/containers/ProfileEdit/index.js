...
const ProfileEdit = (props) => {
  ...
  const [ createProfileDialog, setProfileDialog ] = useState(false);
  const [ createProfileUpdStatus, setProfileUpdStatus ] = useState(true);
  ...
  return (
    <div className="profile-edit-page">
      ...
      <ProfileUpdateDialog
        show={createProfileDialog}
        closeProfileDlg={() => {
          setProfileDialog(false);
          history.push('/profile');
        }}
        profileUpdateStatus={createProfileUpdStatus}
      />
    </div>
  );
};
